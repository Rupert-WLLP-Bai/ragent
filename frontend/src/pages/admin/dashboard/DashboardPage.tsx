...
import { DashboardSidebar, type HealthStatus, type MetricStatusView } from "@/components/admin/DashboardSidebar";
import {
  SimpleLineChart,
  type ChartThreshold,
  type ChartXAxisMode,
...
const KPISection = ({ overview }: { overview: DashboardOverview | null }) => {
  ...
  const items: KPICardProps[] = [
    ...
    {
      value: sessionDepth === null ? "-" : sessionDepth.toFixed(2),
      label: "会话深度（条/会话）",
      change: undefined,
...
// sidebar widgets moved to components/admin/DashboardSidebar.tsx
